...
function Singleproduct() {
        ...
        <div className="w-full px-4 mb-8 md:w-1/2 md:mb-0">
          <div className="sticky top-0 overflow-hidden ">
            <div className="relative mb-6 lg:mb-10 lg:h-96">
              ...
              <img className="object-contain w-full lg:h-full" src="https://lenzstore.cyenosure.in/assets/images/products/product7.jpg" alt />
              <Link className="absolute right-0 transform lg:mr-2 top-1/2 translate-1/2" href="#">
            ...
            <div className="flex-wrap hidden -mx-2 md:flex">
              <div className="w-1/2 p-2 sm:w-1/4">
                <Link className="block border border-gray-200 hover:border-blue-400 dark:border-gray-700 dark:hover:border-blue-300" href="#">
                  <img className="object-contain w-full lg:h-28" src="https://lenzstore.cyenosure.in/assets/images/products/product7.jpg" alt />
                </Link>
              </div>
              <div className="w-1/2 p-2 sm:w-1/4">
                <Link className="block border border-gray-200 hover:border-blue-400 dark:border-gray-700 dark:hover:border-blue-300" href="#">
            ...
            <div className="mb-6 ">
              ...
              <div className="flex flex-wrap items-center mb-6">
                <ul className="flex mb-4 mr-2 lg:mb-0">
                  <li>
                    <a href="#">
                      <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} fill="currentColor" className="w-4 mr-1 text-blue-500 dark:text-gray-400 bi bi-star " viewBox="0 0 16 16">
  ...
  <input 
    ...
    name="gender" 
    value="men" 
    className="rounded-full text-blue-500 focus:ring-blue-400"
  />
  ...
  <input 
    ...
    name="gender" 
    value="women" 
    className="rounded-full text-pink-500 focus:ring-pink-400"
  />
